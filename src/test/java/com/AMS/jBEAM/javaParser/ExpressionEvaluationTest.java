...
public class ExpressionEvaluationTest
{
	...
	public void testGenerics() {
		class TestClass
		{
			Collection<Integer>	collListInt		= Lists.newArrayList(1);
			Collection<String>	collListString	= Lists.newArrayList("2");
			Collection<Integer>	collSetInt		= Sets.newHashSet(3);
			Collection<String>	collSetString	= Sets.newHashSet("4");
