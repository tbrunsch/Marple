...
public class FieldTree extends JPanel
{
	...
	private static class FieldTreeModel implements TreeModel
	{
		...
		private FieldTreeModel(Object rootObject, InspectionContext<?, ?> inspectionContext) {
	...
	private static class ObjectTreeNode extends DefaultMutableTreeNode implements ActionProviderTreeNode
	{
		...
		private ObjectTreeNode(String key, Object value, TypeInfo typeInfo, int childIndex, InspectionContext<?, ?> inspectionContext) {
			super(value);
			this.key = key;
