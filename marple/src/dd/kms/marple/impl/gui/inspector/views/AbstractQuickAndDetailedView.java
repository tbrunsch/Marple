...
public abstract class AbstractQuickAndDetailedView extends JPanel implements ObjectView
{
	...
	protected abstract Component createView(ViewType viewType, ObjectInfo objectInfo, InspectionContext context);
	...
	private void setViewType(ViewType viewType) {
		Component view = createView(viewType, objectInfo, context);
