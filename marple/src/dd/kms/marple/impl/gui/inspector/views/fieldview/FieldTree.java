...
public class FieldTree extends JPanel
{
	...
	public FieldTree(ObjectInfo objectInfo, boolean limitTreeSize, InspectionContext context) {
		super(new GridBagLayout());

		TreeModel model = InspectionTreeNodes.createModel(null, objectInfo, limitTreeSize, context);
		tree.setModel(model);
