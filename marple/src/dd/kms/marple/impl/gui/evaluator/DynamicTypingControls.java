...
class DynamicTypingControls
{
	...
	DynamicTypingControls(InspectionContext context) {
	...
	private boolean isEnableDynamicTyping() {
		return ExpressionEvaluators.getValue(ParserSettings::isEnableDynamicTyping, context);
	}

	private void setEnableDynamicTyping(boolean enable) {
		ExpressionEvaluators.setValue(enable, ParserSettingsBuilder::enableDynamicTyping, context);
	}
